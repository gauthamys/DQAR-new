...
| Metric | Value |
|--------|-------|
| **Best Speedup** | 1.56× (quant_cache_only) |
...
|---------------|-------------|---------|---------|------------|-------|
| No DQAR (baseline) | 0.891s | 1.00× | 0.0% | 0.0 | Reference baseline |
| Layer scheduling only (FP16 cache) | 0.670s | 1.33× | 38.7% | 126.0 |  |
| INT8 quantized cache (all layers) | 0.572s | 1.56× | 98.0% | 126.0 |  |
| Full DQAR (scheduling + INT8) | 0.649s | 1.37× | 38.7% | 126.0 | Recommended config |
...
✅ **Target achieved**: 1.56× speedup with quant_cache_only configuration.
